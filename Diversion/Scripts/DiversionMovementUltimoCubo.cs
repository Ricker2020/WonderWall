...
public class DiversionMovementUltimoCubo : MonoBehaviour
{
    ...
    public float minY = 1f; // Límite inferior del rango en el eje Y
    public float maxY = 5f; // Límite superior del rango en el eje Y
